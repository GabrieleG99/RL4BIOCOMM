...
class PopArt(torch.nn.Module):
    ...
    def __init__(self, input_shape, output_shape, norm_axes=2, beta=0.99999, epsilon=1e-5, device=torch.device("cpu")):
    ...
    def update(self, input_vector):
        ...
        self.weight = nn.Parameter(self.weight * old_stddev / new_stddev)
        self.bias = nn.Parameter((old_stddev * self.bias + old_mean - new_mean) / new_stddev)
